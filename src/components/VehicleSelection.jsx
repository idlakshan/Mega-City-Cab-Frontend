...
const VehicleSelection = () => {
    ...
    const vehicles = [
        { name: 'Budget', icon: Budget, details: { title: 'Budget', features: ['Flexible Price', 'Air Conditioned', '3 Passengers', 'Limited Baggage'], price: 'LKR 1500.00' } },
        { name: 'City', icon: City, details: { title: 'City', features: ['Flexible Price', 'Air Conditioned', '3 Passengers', 'Limited Baggage'], price: 'LKR 2000.00' } },
        { name: 'Semi', icon: Semi, details: { title: 'Semi', features: ['Flexible Price', 'Air Conditioned', '4 Passengers', 'Medium Baggage'], price: 'LKR 2500.00' } },
        { name: 'Luxury', icon: Car, details: { title: 'Luxury', features: ['Flexible Price', 'Air Conditioned', '5 Passengers', 'Large Baggage'], price: 'LKR 3000.00' } },
        { name: 'Van', icon: Van, details: { title: 'Van', features: ['Flexible Price', 'Air Conditioned', '7 Passengers', 'Extra Baggage'], price: 'LKR 4000.00' } }
    ];
                        ...
                        <>
                            <div className="flex flex-col md:flex-row justify-between items-center w-full mb-3">
                                ...
                                <div className="bg-primary-light w-32 h-8 rounded-md shadow-sm flex justify-center items-center mt-2 md:mt-0">
                                    <span className="text-primary-black font-bold">{selectedVehicleDetails.price}</span>
                                </div>
                            </div>
