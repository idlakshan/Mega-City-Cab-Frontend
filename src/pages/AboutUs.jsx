    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          solutions. We are dedicated to making your journey comfortable and
          stress-free.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <p className="text-gray-600 mb-4">
            Mega Cabs was founded in 2010 with a vision to revolutionize the
            transportation industry. Over the years, we have grown into one of
            the most trusted cab service providers in the region.
          </p>
          <p className="text-gray-600">
            Our commitment to excellence and customer satisfaction has earned us
            a loyal customer base and numerous industry accolades.
          </p>
        </div>
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-primary-black mb-4">
          ...
          <p className="text-gray-600 mb-4">
            ...
            that exceed customer expectations. We strive to make every ride a
            pleasant experience.
          </p>
          <p className="text-gray-600">
            Our mission is to connect people with their destinations seamlessly,
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <h2 className="text-3xl font-bold text-primary-black text-center mb-8">
          Meet Our Team
        </h2>
      ...
      <div className="max-w-7xl mx-auto bg-primary-black text-white p-8 rounded-lg shadow-lg text-center">
        ...
        <Link
          to="/"
          className="bg-[#FCC737] text-primary-black px-6 py-3 rounded-lg font-semibold hover:bg-yellow-500 transition-colors duration-300"
        >
          Book Now
        </Link>
      </div>
