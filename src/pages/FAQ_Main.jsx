  ...
  const faqs = [
    {
      ...
      answer:
        "You can easily view all your bookings in the 'My Trips' section on our website or app, keeping track of your upcoming journeys with ease.",
    },
    {
      heading: "Trip Management",
      question: "How can I cancel my trip?",
      answer:
        "Canceling your trip is simple! Just give us a call, and our support team will assist you in swiftly canceling your booking without any hassle.",
    },
    {
      heading: "Service Availability",
      question: "Do you offer 24/7 service?",
      answer:
        "Yes! Mega Cabs operates 24/7, ensuring you have access to reliable transportation whenever you need it, day or night.",
    },
    {
      heading: "Vehicle Options",
      question: "Can I choose the type of vehicle for my trip?",
      answer:
        "Absolutely! You can select from a range of vehicle options based on your preferences and travel needs, all at the touch of a button.",
    },
  ];
  ...
  return (
    <div className="section_container">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://kangaroocabs.com/assets/hero-ac80e8ed.jpg')",
      ...
      >
        ...
        <div className="absolute inset-x-0 top-16 flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <h3 className="text-lg sm:text-2xl lg:text-xl pt-10">
            Find solutions to common queries about our services in our FAQ
            section
          </h3>
        </div>
      </div>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="mb-6 w-[90%] md:w-[100%] mx-auto">
              <div className="bg-[#EDF1F2] min-h-[80px] rounded-lg shadow-md p-4">
                <h2 className="text-primary-black text-md mb-2">
                  {faq.heading}
                </h2>
                <div
                ...
                >
                  <p className="font-bold text-primary-black text-lg md:text-xl">
                    {faq.question}
                  </p>
                  <div>
                    {activeIndex === index ? (
